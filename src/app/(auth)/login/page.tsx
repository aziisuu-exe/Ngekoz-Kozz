...
export const metadata = {
  title: "Login | Ngekoz",
  description: "Masuk ke akun Ngekoz kamu",
};
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="flex flex-col gap-4 p-6 md:p-10 bg-white">
        <div className="flex justify-center gap-2 md:justify-start">
          <Link href="/" className="flex items-center gap-2 font-bold text-xl text-gray-900">
            {/* Ubah Logo menjadi Gradasi Ungu Premium */}
      ...
      <div className="relative hidden bg-gray-900 lg:block">
        ...
        />
        {/* Ubah gradient overlay menjadi kombinasi hitam ke ungu gelap */}
        ...
        <div className="absolute bottom-10 left-10 right-10 text-white">
          <h2 className="text-3xl font-bold mb-2">Temukan Kos Idamanmu.</h2>
          <p className="text-gray-300">
            Platform pencarian dan pemesanan kos paling aman, cepat, dan transparan di Indonesia.
          </p>
        </div>
      </div>
    </div>
